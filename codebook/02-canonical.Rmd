...
filename <- "02-executive-function"
capture.output(
  MplusAutomation::prepareMplusData(executive.function, 
                                    paste0("external/",filename,".dat")),
  file=paste0("external/",filename,"-MplusAutomation.txt"))
```
...
download_file(
  path = paste0("external/",
                c(paste0(filename,".dat"),
                  paste0(filename,"-MplusAutomation.txt"),
                  "02-canonical-mlm.inp", "02-canonical-mlm.out",
                  "02-canonical-lcm.inp", "02-canonical-lcm.out",
                  "02-canonical-lcsm.inp", "02-canonical-lcsm.out",
                  "02-canonical-lcsm-proportional.inp", 
                  "02-canonical-lcsm-proportional.out",
                  "03-accelerated-wide.dat",
                  "03-accelerated.inp", "03-accelerated.out",
                  "05-executive-function.dat",
                  "05-randomTVC-lcm.inp", "05-randomTVC-lcm.out",
                  "05-externalizing.dat",
                  "05-catML-distaloutcome.inp", "05-catML-distaloutcome.out",
                  "06-achieve.dat",
                  "06-threelevel-lcm.inp", "06-threelevel-lcm.out",
                  "06-clustercorrect-lcm.inp", "06-clustercorrect-lcm.out")),
  output_name = "primer-mpluscode",
...
foreign::write.foreign(executive.function.long, 
                       datafile = paste0("external/",filename,".csv"), 
                       codefile = paste0("external/",filename,"-import.sas"), 
                       package="SAS")
```
...
download_file(
  path = paste0("external/",
                c(paste0(filename,".csv"),
                  paste0(filename,"-import.sas"),
                  "02-canonical-mlm.sas",
                  "02-executive-function.csv",
                  "05-multivariate-mlm.sas",
                  "05-multivar-long.csv",
                  "06-achieve.csv",
                  "06-threelevel-mlm.sas")),
  output_name = "primer-sascode",
